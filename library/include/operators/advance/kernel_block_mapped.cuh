...
__global__ void advanceKernelBlockMapped(GraphDevT graph_dev,
  ...
  while (true) {
    ...
    processBlockMappedTile<View, Direction, BlockSize>(graph_dev, in_dev_frontier, out_dev_frontier, coarsening_factor,
                                                       tile, functor, vertices, start_edges, scan_begins, scan_ends,
                                                       total_edges, scan_storage, tid, block_dim);
  }
